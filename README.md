...
The acceleration source, tests, and benchmarks are maintained on [`rust`](https://github.com/zhouhaoyiu/SSFPG/tree/rust):
...
See [`README_FAST.md` on the `rust` branch](https://github.com/zhouhaoyiu/SSFPG/blob/rust/README_FAST.md) for implementation details, complete benchmark results, and numerical limits.
